		...
		<div class="contentadmin" style="background: white;">
			<div>
				<div class="padding" align="center">
						...
						<form method="post" action="AddCourse2.jsp" name="add" onsubmit="return(validate())">
								...
								<div class="padding" align="center">
									<div class="wrapper margin-bot">
										...
										<table class="tablemod" style="width: 700px;align:center">
											<tr>
												<td align="center" colspan="4"><h2 style="color:black;margin-left:150px">ADD COURSE</h2></td>
																						
											</tr>
											
											<tr>
												<td align="Right" style="color:Green">Course Name</td>
												<td colspan="2" align="center"><input type="text" name="course" id="course"/></td>
												
											</tr>

											<tr>
												<td align="Right"  style="color:Green">Description</td>
												<td colspan="2" align="center"><textarea rows="5"  name="description"></textarea></td>
											</tr>
