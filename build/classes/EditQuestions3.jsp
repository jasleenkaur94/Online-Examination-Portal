		...
		<div class="contentadmin" style="background: white;">
			<div>
				<div class="padding" align="center">
						...
						<form method="post" action="EditQuestions4.jsp" name="add" onsubmit="return(validate())">
								...
								<div class="padding" align="center">
									<div class="wrapper margin-bot">
										...
										<table class="tablemod" style="width: 700px;align:center">
											<tr>
												<td align="center" colspan="4"><h2 style="color:black">Edit Question</h2></td>					
											</tr>
											<tr>
												<td align="Center" style="color:Green">Question Number</td>
												<td colspan="2" align="left" style="color:black;margin-left:50px">
												<input type="text" name="questionid" value="${questionno}" disabled/>
											...
											<tr>
												...
												<textarea rows="5" cols="50" name="question">${question}</textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 1</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option1">${option1}</textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 2</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option2">${option2}</textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 3</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option3">${option3}</textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 4</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option4">${option4}</textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Select Correct Answer</td>
												<td colspan="2" align="left">
												<select name="answer">
												<option >${answer}&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</option>
