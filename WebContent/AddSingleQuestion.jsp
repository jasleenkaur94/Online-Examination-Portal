...
Select questionid from questions where course=? and quiz=?
		...
		<div class="contentadmin" style="background: white;">
			<div>
				<div class="padding" align="center">
						...
						<form method="post" action="AddQuestions2.jsp" name="add" onsubmit="return(validate())">
								...
								<div class="padding" align="center">
									<div class="wrapper margin-bot">
										...
										<table class="tablemod" style="width: 700px;align:center">
											<tr>
												<td align="center" colspan="4"><h2 style="color:black">Add Question</h2></td>					
											</tr>
											<tr>
												<td align="Center" style="color:Green">Question Number</td>
												<td colspan="2" align="left" style="color:black;margin-left:50px">
												<input type="text" name="questionid" value="${questionno+1}" disabled/>
												<input type="hidden" name="questionid" value="${questionno+1}"/>
											...
											<tr>
												...
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option1"></textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 2</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option2"></textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 3</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option3"></textarea>
												</td>
											</tr>
											<tr>
												<td align="center"  style="color:Green">Option 4</td>
												<td colspan="2" align="center">
												<textarea rows="2" cols="50" name="option4"></textarea>
												</td>
											</tr>
											<tr>
