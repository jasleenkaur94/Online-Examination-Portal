...
<%	int questionid;
	...
	PreparedStatement ps=conn.prepareStatement("Select questionid,question,option1,option2,option3,option4,answer from questions where course=? and quiz=?");
	ps.setString(1,(String)session.getAttribute("Course"));
	ps.setString(2,request.getParameter("quiz") );
	...
	%>
<jsp:forward page="ShowQuestion.jsp"></jsp:forward>
