		...
		<div class="contentadmin" style="background: white;min-height:300px">
			<div>
				<div class="padding" align="center">
						...
						<form method="post" action="EditQuestions3.jsp" name="delete1" >
								...
								<div class="padding" align="center">
									<div class="wrapper margin-bot">
										...
										<table class="tablemod" style="width: 700px;align:center">
											<tr>
												<td align="center" colspan="4"><h2 style="color:black;margin-left:150px">Edit Question</h2></td>
